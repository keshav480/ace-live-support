...
**ACE Live Support** is a lightweight and powerful real-time chat plugin for WordPress.  
...
1. Upload the plugin folder `ace-live-support` to the `/wp-content/plugins/` directory.  
2. Activate the plugin from **Plugins → Installed Plugins**.  
3. Go to **Settings → Ace Live Support**.  
...
= 1.0.0 =
Major first stable release of ACE Live Support. Update recommended for full functionality.

== Credits ==

ACE Live Support is created and maintained by AceWebX.
